...
export function BookingOptions({ options = [], bookingCopy, contactEmail, contactPhone }: BookingOptionsProps) {
  ...
  const email = contactEmail || "dan@financialtraumatherapist.com.au"
  ...
  return (
    <div className="space-y-12">
      <div className="rounded-[40px] border-2 border-[#78a3ab] bg-[var(--section-bg-1)]/85 p-5 sm:p-8 lg:p-10 shadow-[0_30px_70px_rgba(45,69,78,0.12)] backdrop-blur">
      ...
      <div className="rounded-[32px] border-2 border-[#78a3ab] bg-[#d7e9ec] p-5 sm:p-6 shadow-sm">
