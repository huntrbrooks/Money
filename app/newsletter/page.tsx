          ...
          <div className="container mx-auto px-4 sm:px-6 md:px-8">
            <div className="max-w-4xl mx-auto space-y-6 text-center">
              ...
              <h1 className="font-serif text-4xl md:text-5xl text-[var(--foreground)] font-light">
                A gentler money letter (and a safety ritual to start)
              </h1>
              <p className="text-[var(--primary)] text-lg">
                Join the list to receive the 5-step Financial Safety Check-in plus occasional notes when new resources
                or sessions become available. No spam, just care.
              </p>
